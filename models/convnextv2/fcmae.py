"""
Fully convolutional masked autoencoder (FCMAE) for image reconstruction using DenseConvNeXtV2.
Adapted from https://github.com/facebookresearch/ConvNeXt-V2/blob/2553895753323c6fe0b2bf390683f5ea358a42b9/models/fcmae.py
"""
...
class FCMAE(nn.Module):
    ...
    def __init__(
        ...
        # encoder
        stem_size = 4 if img_size == 224 else 2
